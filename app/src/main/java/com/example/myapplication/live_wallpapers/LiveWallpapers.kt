...
class LiveWallpapers : Fragment(), GestureDetector.OnGestureListener{
    ...
    private lateinit var viewModel: LiveWallpaperViewModel
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_live_wallpapers, container, false)
...
//        }
    ...
    private fun initRecyclerView() {
        ...
        adapter = LiveWallpapersAdapter(requireContext(), wallpaperList,findNavController())
        recyclerView.adapter = adapter


        viewModel = ViewModelProvider(this).get(LiveWallpaperViewModel::class.java)
